...
isTaggedObjectValue (Object obj) = "tag"      `TM.member` obj &&
                                   "contents" `TM.member` obj
...
isTaggedObject' (Object obj) = "tag" `TM.member` obj
isTaggedObject' _            = False

isObjectWithSingleField :: Value -> Bool
isObjectWithSingleField (Object obj) = TM.size obj == 1
