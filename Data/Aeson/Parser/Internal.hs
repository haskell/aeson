...
json_ obj ary = (do
  ...
  if w == OPEN_CURLY
    then obj
    else ary) <?> "not a top-level value (object, array)"
{-# INLINE json_ #-}
...
objectValues str val = (do
  ...
  H.fromList <$> commaSeparated pair CLOSE_CURLY) <?> "bad oject syntax"
{-# INLINE objectValues #-}
...
arrayValues val = (do
  skipSpace
  Vector.fromList <$> commaSeparated val CLOSE_SQUARE) <?> "bad array syntax"
{-# INLINE arrayValues #-}
